<%@page import="com.cine.cine.presentation.encontrado.Model"%>
    ...
    <body>
        ...
        <div class="detalle">
            <div class="detalle-imagen">
                <img src="http://localhost:8080/Cine/presentation/encontrado/imagen?nombre=<%=model.getPelicula().getNombre()%>.png" alt="p1" height="100">
            </div>
            <div class="columna1">
                <p>Película</p>
                <p>Formato</p>
